...
for i in range(0, rowmax+1):
    for j in range(0, colmax+1):
        if (i**2+j**2) >= 0         and (1**2+j**2) < batas1**2:
            Gambar[i, j, 0] = 255
        if (i ** 2 + j ** 2) >= batas1**2 and (1 ** 2 + j ** 2) < batas2**2:
            Gambar[i, j, 1] = 255
        if (i ** 2 + j ** 2) >= batas2**2 and (1 ** 2 + j ** 2) < batas3**2:
            Gambar[i, j, 2] = 255
        if (i ** 2 + j ** 2) >= batas3**2 and (1 ** 2 + j ** 2) < batas4**2:
            Gambar[i, j, 0] = 255
            Gambar[i, j, 1] = 255
        if (i ** 2 + j ** 2) >= batas4 ** 2 and (1 ** 2 + j ** 2) < radius_max**2:
            Gambar[i, j, 0] = 255
            Gambar[i, j, 2] = 255
